...
def search_button_clicked():
    ...
    if search_input in df["ISIN"].values:
        ...
        global eusan_var 
        eusan_var = tk.BooleanVar()
        eusan_var.set(1)
        eusan_cb = tk.Checkbutton(new_window,text = "Eusan",variable = eusan_var)
        eusan_cb.pack()
        ...
        delete_button.pack()
        update_button = tk.Button(new_window, text="Update Company", font=("微軟正黑體", 16))
        update_button.pack()
        ...
        catchy_var = tk.BooleanVar()
        fubon_var = tk.BooleanVar()

        eusan_checkbox = tk.Checkbutton(new_window, text='玉山', variable=eusan_var, font=("微軟正黑體", 16))
        sbc_checkbox = tk.Checkbutton(new_window, text='星展', variable=sbc_var, font=("微軟正黑體", 16))
        catchy_checkbox = tk.Checkbutton(new_window, text='國泰', variable=catchy_var, font=("微軟正黑體", 16))
...
#=------
test_bc_var = tk.BooleanVar()
test_bc_var.set(1)
t_bc = tk.Checkbutton(page1,text="fuck",variable = test_bc_var)
#t_bc.pack()
